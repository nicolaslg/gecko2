...
class Mesh
{
 ...
 public:
	 ...
	 */
	template<typename T>  T get(const TCellID &AID) const;
	 ...
	 */
	template<typename T>  void getAll(std::vector<T> &AVec) const;
	...
	/** \brief Tell if there is a T-type cell having id AID
         ...
         * \param AID the id of the cell we look for
	 */
	template<typename T>  bool has(const TCellID &AID) const;
	 ...
	 */
	template<typename T>  TInt newMark();
	...
	/** \brief Get the marks of a cell
         ...
         *  \return A mark
	 */
	template<typename T>  Marks32 getMarks(const T &ACell) const;
	 ...
	 */
	template<typename T>  void freeMark(TInt AMarkNumber);
	...
	/** \brief  Invert the mark value for all the cell in the mesh in O(1). This
         ...
         *  \param AMarkNumber A mark number
	 */
	template<typename T>  void negateMaskMark(TInt AMarkNumber);
	...
	/** \brief  Invert the mark value for all the cell in the mesh in O(n) where
         ...
         *  \param AMarkNumber A mark number
	 */
	template<typename T>  void unmarkAll(TInt AMarkNumber);
	...
	template<typename T>  bool isMarked(const TCellID &ACellID, TInt AMarkNumber) const;
	...
	template<typename T>  void markTo(const TCellID &ACellID, TInt AMarkNumber, bool AState);
	...
	template<typename T>  void mark(const TCellID &ACellID, TInt AMarkNumber);
	/*------------------------------------------------------------------------*/
	...
	template<typename T>  void unmark(const TCellID &ACellID, TInt AMarkNumber);
...
/*----------------------------------------------------------------------------*/
template<>  CellGroup<Node> *Mesh::newGroup<Node>(const std::string &AName);
template<>  CellGroup<Edge> *Mesh::newGroup<Edge>(const std::string &AName);
template<>  CellGroup<Face> *Mesh::newGroup<Face>(const std::string &AName);
template<>  CellGroup<Region> *Mesh::newGroup<Region>(const std::string &AName);
/*----------------------------------------------------------------------------*/
template<>  void Mesh::deleteGroup<Node>(CellGroup<Node> *ACloud);
template<>  void Mesh::deleteGroup<Edge>(CellGroup<Edge> *ACloud);
template<>  void Mesh::deleteGroup<Face>(CellGroup<Face> *ACloud);
template<>  void Mesh::deleteGroup<Region>(CellGroup<Region> *ACloud);
/*----------------------------------------------------------------------------*/
template<>  CellGroup<Node> *Mesh::getGroup<Node>(const std::string &AName);
template<>  CellGroup<Edge> *Mesh::getGroup<Edge>(const std::string &AName);
template<>  CellGroup<Face> *Mesh::getGroup<Face>(const std::string &AName);
template<>  CellGroup<Region> *Mesh::getGroup<Region>(const std::string &AName);
/*----------------------------------------------------------------------------*/
template<>  CellGroup<Node> *Mesh::getGroup<Node>(unsigned int AIndex);
template<>  CellGroup<Edge> *Mesh::getGroup<Edge>(unsigned int AIndex);
template<>  CellGroup<Face> *Mesh::getGroup<Face>(unsigned int AIndex);
template<>  CellGroup<Region> *Mesh::getGroup<Region>(unsigned int AIndex);
/*----------------------------------------------------------------------------*/
template<>  unsigned int Mesh::getNbGroups<Node>() const;
template<>  unsigned int Mesh::getNbGroups<Edge>() const;
template<>  unsigned int Mesh::getNbGroups<Face>() const;
template<>  unsigned int Mesh::getNbGroups<Region>() const;
/*----------------------------------------------------------------------------*/
template<>  Mesh::group_iterator<Node> Mesh::groups_begin<Node>();
template<>  Mesh::group_iterator<Edge> Mesh::groups_begin<Edge>();
template<>  Mesh::group_iterator<Face> Mesh::groups_begin<Face>();
template<>  Mesh::group_iterator<Region> Mesh::groups_begin<Region>();
/*----------------------------------------------------------------------------*/
template<>  Mesh::group_iterator<Node> Mesh::groups_end<Node>();
template<>  Mesh::group_iterator<Edge> Mesh::groups_end<Edge>();
template<>  Mesh::group_iterator<Face> Mesh::groups_end<Face>();
template<>  Mesh::group_iterator<Region> Mesh::groups_end<Region>();

/*----------------------------------------------------------------------------*/
template<>  void Mesh::getAll<Node>(std::vector<Node> &AVec) const;

template<>  void Mesh::getAll<Edge>(std::vector<Edge> &AVec) const;

template<>  void Mesh::getAll<Face>(std::vector<Face> &AVec) const;

template<>  void Mesh::getAll<Region>(std::vector<Region> &AVec) const;

/*----------------------------------------------------------------------------*/
template<>  bool Mesh::has<Node>(const TCellID &AID) const;
template<>  bool Mesh::has<Edge>(const TCellID &AID) const;
template<>  bool Mesh::has<Face>(const TCellID &AID) const;
template<>  bool Mesh::has<Region>(const TCellID &AID) const;
/*----------------------------------------------------------------------------*/
template<>  Node Mesh::get<Node>(const TCellID &AID) const;
template<>  Edge Mesh::get<Edge>(const TCellID &AID) const;
template<>  Face Mesh::get<Face>(const TCellID &AID) const;
template<>  Region Mesh::get<Region>(const TCellID &AID) const;

/*----------------------------------------------------------------------------*/
template<>  void Mesh::freeMark<Node>(TInt AMarkNumber);
template<>  void Mesh::freeMark<Edge>(TInt AMarkNumber);
template<>  void Mesh::freeMark<Face>(TInt AMarkNumber);
template<>  void Mesh::freeMark<Region>(TInt AMarkNumber);

/*----------------------------------------------------------------------------*/
template<>  void Mesh::unmarkAll<Node>(TInt AMarkNumber);
template<>  void Mesh::unmarkAll<Edge>(TInt AMarkNumber);
template<>  void Mesh::unmarkAll<Face>(TInt AMarkNumber);
template<>  void Mesh::unmarkAll<Region>(TInt AMarkNumber);

/*----------------------------------------------------------------------------*/
template<>  void Mesh::unmark<Node>(const TCellID &ACellID, TInt AMarkNumber);
template<>  void Mesh::unmark<Edge>(const TCellID &ACellID, TInt AMarkNumber);
template<>  void Mesh::unmark<Face>(const TCellID &ACellID, TInt AMarkNumber);
template<>  void Mesh::unmark<Region>(const TCellID &ACellID, TInt AMarkNumber);

/*----------------------------------------------------------------------------*/
template<>  void Mesh::mark<Node>(const TCellID &ACellID, TInt AMarkNumber);
template<>  void Mesh::mark<Edge>(const TCellID &ACellID, TInt AMarkNumber);
template<>  void Mesh::mark<Face>(const TCellID &ACellID, TInt AMarkNumber);
template<>  void Mesh::mark<Region>(const TCellID &ACellID, TInt AMarkNumber);
/*----------------------------------------------------------------------------*/
template<>  void Mesh::markTo<Node>(const TCellID &ACellID, TInt AMarkNumber, bool AState);
template<>  void Mesh::markTo<Edge>(const TCellID &ACellID, TInt AMarkNumber, bool AState);
template<>  void Mesh::markTo<Face>(const TCellID &ACellID, TInt AMarkNumber, bool AState);
template<>  void Mesh::markTo<Region>(const TCellID &ACellID, TInt AMarkNumber, bool AState);

/*----------------------------------------------------------------------------*/
template<>  bool Mesh::isMarked<Node>(const TCellID &ACellID, TInt AMarkNumber) const;
template<>  bool Mesh::isMarked<Edge>(const TCellID &ACellID, TInt AMarkNumber) const;
template<>  bool Mesh::isMarked<Face>(const TCellID &ACellID, TInt AMarkNumber) const;
template<>  bool Mesh::isMarked<Region>(const TCellID &ACellID, TInt AMarkNumber) const;
/*----------------------------------------------------------------------------*/
template<>  void Mesh::negateMaskMark<Node>(TInt AMarkNumber);
template<>  void Mesh::negateMaskMark<Edge>(TInt AMarkNumber);
template<>  void Mesh::negateMaskMark<Face>(TInt AMarkNumber);
template<>  void Mesh::negateMaskMark<Region>(TInt AMarkNumber);
/*----------------------------------------------------------------------------*/
template<>  TInt Mesh::newMark<Node>();
template<>  TInt Mesh::newMark<Edge>();
template<>  TInt Mesh::newMark<Face>();
template<>  TInt Mesh::newMark<Region>();
/*----------------------------------------------------------------------------*/
template<>  Marks32 Mesh::getMarks<Node>(const Node &ACell) const;
template<>  Marks32 Mesh::getMarks<Edge>(const Edge &ACell) const;
template<>  Marks32 Mesh::getMarks<Face>(const Face &ACell) const;
template<>  Marks32 Mesh::getMarks<Region>(const Region &ACell) const;
/*----------------------------------------------------------------------------*/
}     // namespace gmds
/*----------------------------------------------------------------------------*/
