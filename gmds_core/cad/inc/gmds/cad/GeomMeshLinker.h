...
/*----------------------------------------------------------------------------*/
        ...
        public:
             ...
             * @return the dimension of the geom entity AN is classified on
             */
            template<typename T>  eLink getGeomDim(const TCellID& AN);
            /*------------------------------------------------------------------------*/
            /**@ brief accessor on the id of the geom entity AN is classified on.
             *
             * @param AN a node id
             * @return the dimension of the geom entity AN is classified on
             */
            template<typename T>  int getGeomId(const TCellID& AN);
             ...
             * @return the (dim, id) of the geom entity AN is classified on
             */
            template<typename T>   std::pair<eLink,int> getGeomInfo(const TCellID& AN);
